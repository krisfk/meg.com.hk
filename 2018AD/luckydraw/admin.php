...
header('Location: https://www.hksm.com.hk/2018AD/luckydraw/admin.php');
...
<body>
  ...
  <img class="hksm-logo" src="https://www.hksm.com.hk/eng/images/hksm_logo.png">
    ...
    <h1 class="heading-title">2018週年晚宴<br/>幸運大抽獎管理系統</h1>
    
    <img class="present-icon" src="present.png">
...
<tr>
<th class="admin-th-col-1" ><span style="color: #ffffff;">獎號</span></th>
<th class="admin-th-col-2" ><span style="color: #ffffff;">中獎員工</span></th>
<th class="admin-th-col-3" ><span style="color: #ffffff;">姓名</span></th>
<th class="admin-th-col-4"><span style="color: #ffffff;">取獎</span></th>
<th class="admin-th-col-5" ><span style="color: #ffffff;"></span></th>

...
$(document).ready(function(){
		<!--loop();  car-->
		   ...
		   $("#index, #index_s , #back_btn").click(function(){
		   	window.location.href = "./index.html";
		    
		   }); 
 
		   $("#latest_news, #notices, #type_latest_news, #back_notices, #latest_news_2016").click(function(){
		   	window.location.href = "./latest_news.html";
		    
		   });
		   
		   $("#promotion1").click(function(){
			window.open('http://meg.com.hk/event/minimovie2017/index.html');
		    
		   });
		   
		   $("#promotion2").click(function(){
			window.open('http://www.meg.com.hk/promo/ad3.html');
		   ...
		   $("#latest_news_2015").click(function(){
		     ...
		     $("#latest_news_2016").click(function(){
		   	window.location.href = "./latest_news_2016.html";
		    
		   });
		   
		    $("#latest_news_2017").click(function(){
		   	window.location.href = "./latest_news.html";
		   ...
		   $("#leinam").click(function(){
			window.open('http://www.leinam.com.hk/site/index.php');
		    
		   });
		   
		   $("#tctc").click(function(){
			window.open('http://www.tctc.com.hk/chi/home/index.html');
		   ...
		   $("#enroll").click(function(){
			window.open('http://meg.com.hk/promo/payment_may2017.html');
		   ...
		   $('a.eng').click(function() {
			...
			window.open('http://www.hksm.com.hk/eng/');
      });
...
$(function(){
	...
	switch (relang){
		case "zh-cn":
		document.getElementById("meg_copy").innerHTML='Copyright © '+ year +' MEG Ltd. All Rights Reserved. 建议使用Microsoft Internet Explorer 8.0以上或Google Chrome浏览本网站';	<!--copyright-->
		break;
 
		case "zh-hk":
		document.getElementById("meg_copy").innerHTML='Copyright © '+ year +' MEG Ltd. All Rights Reserved. 建議使用Microsoft Internet Explorer 8.0以上或Google Chrome瀏覽本網站';	<!--copyright-->
		break;
		
		case "en":
		document.getElementById("meg_copy").innerHTML='Copyright © '+ year +' MEG Ltd. All Rights Reserved.';	<!--copyright-->
		break;

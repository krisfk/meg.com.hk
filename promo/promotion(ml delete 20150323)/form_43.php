...
<div class='section'>
	<div><a href="http://www.hksm.com.hk/tc/index"><img alt="band" border="0" src="band_1k-02.png" width="1000" height="165"></a></div>
...
<div class='section'>
	...
	<form method="post" action="Savemeg_reg.php" name="frmRegistration" onSubmit="return submitForm();" accept-charset="UTF-8">
		...
		<input type="hidden" name="txtFormNo" value="43"><?php // Matthew 2014-01-23 22 For CNY promotion 2014 2014-01-23 ?>

	</form>

</div>

<div class='section'><a href="http://www.hksm.com.hk/tc/index"><img alt="band" border="0" src="band_1k-02.png" width="1000" height="165"></a></div>

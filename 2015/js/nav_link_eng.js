...
$(document).ready(function(){
		loop();  <!--car-->
		   ...
		   $("#index, #to_index").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/index.html";
		    
		   }); 
 
		   $("#course_1, #course_1a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/course_1.html";
		    
		   });
		   
		   $("#course_2, #course_2a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/course_2.html";
		    
		   });
		   
		   $("#course_3, #course_3a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/course_3.html";
		    
		   });
		   
		   $("#course_4, #course_4a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/course_4.html";
		    
		   });
		   
		   $("#course_5, #course_5a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/course_5.html";
		    
		   });
		   
		   $("#info_1, #info_1a, #info_back").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/info_1.html";
		    
		   });
		   
		   $("#info_2, #info_2a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/info_2.html";
		    
		   });
		   
		   $("#info_3, #info_3a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/info_3.html";
		    
		   });
		   
		   $("#info_4, #info_4a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/info_4.html";
		    
		   });
		   
		   $("#info_5, #info_5a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/info_5.html";
		    
		   });
		   
		   $("#latest_news, #latest_back, #latest_news_1a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/latest_news.html";
		    
		   });
		   
		   $("#other_news, #other_back, #other_news_1a").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/other_news.html";
		    
		   });
		   
		   $("#company").click(function(){
		   	window.location.href = "http://meg.com.hk/eng/company.html";
		    
		   });
		   
		   $("#hksm, #hksm_logo, #hksm_s").click(function(){
			window.open('http://www.hksm.com.hk/eng/index.html');
		   ...
		   $("#location, #location_1a").click(function(){
			window.location.href = "http://meg.com.hk/eng/map.html";
		    
		   });
		   
		   $("#enquiry, #enquiry_1a").click(function(){
			window.location.href = "http://meg.com.hk/eng/enquiry.html";
		    
		   });
		   
		   $("#terms, #terms_1a").click(function(){
			window.location.href = "http://meg.com.hk/eng/terms.html";
		   ...
		   $('a.sc').click(function() {
            document.location.href = document.location.href.replace('/eng/','/sc/');
      });
  		   
	  	   $('a.tc').click(function() {
            document.location.href = document.location.href.replace('/eng/','/tc/');
      });

...
//	$returnURL = $returnURL."course=".urlencode($_POST["course"])."&";
	...
	if ($success == 1) { 
		...
		// Email body
			...
			$body = "The following person has been registered in our web site<br><br>";			
			$body .= "Offer: " . $aryCourseName[$_POST['course']]."<br>";				
			$body .= "Name: " . $_POST['txtName']."<br>";
			$body .= "HKID: " . $_POST['txtHKID']."<br>";			
			$body .= "Email: " . $_POST['txtEmail']."<br>";	
			$body .= "Tel: " . $_POST['txtTel']."<br>";	
			
			$body .= "Region: " . $aryArea[$_POST['area']]."<br>";	
			$body .= "Age Group: " . $aryAge[$_POST['age']]."<br>";	
			$body .= "Job Category: " . $aryOccupation[$_POST['occupation']]."<br>";	
...
//			$body .= "Coupon No: " . $couponno."<br>";		
	...
	$email = "py@meg.hk"; // !!! Email receivers

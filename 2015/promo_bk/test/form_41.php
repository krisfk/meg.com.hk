...
<div class='section'>
	<div><img alt="band" border="0" src="band_1k.png" width="1000" height="165" usemap="#bandmap"></div>
	<div><img alt="ad" border="0" src="ad_1k.png" width="1000" height="786"></div>
</div>
...
<div class='section'>
	...
	<form method="post" action="Savemeg_reg.php" name="frmRegistration" onSubmit="return submitForm();" accept-charset="UTF-8">
		...
		<input type="hidden" name="txtFormNo" value="41"><?php // Matthew 2014-01-23 22 For CNY promotion 2014 2014-01-23 ?>

	</form>

</div>

<div class='section'><img alt="band" border="0" src="band_1k.png" width="1000" height="165" usemap="#bandmap"></div>

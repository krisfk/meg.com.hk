...
$(document).ready(function(){
		loop();  <!--car-->
		   ...
		   document.getElementById("ktcopy").innerHTML='Copyright © 2015 MEG Ltd. All Rights Reserved<br />建议使用 Microsoft Internet Explorer 8.0以上或Google Chrome浏览本网站</br>';	<!--copyright-->

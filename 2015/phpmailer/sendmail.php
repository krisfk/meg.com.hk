...
if ($_GET["go"] != "1") {	
	...
	{	
		...
		if ($tmp_type=='CEO' || $tmp_type=='GMO'){
	    	...
	    	$body .= "Please click the following link and enjoy to view it!<br><br><a href='http://www.hksm.com.hk/ecard201012a/getcard.php?batch=1&code=".$row["card_code"]."&tmp_type=".$row["type"];
	    	$body .= "'>http://www.hksm.com.hk/ecard201012a/getcard.php?batch=1&code=".$row["card_code"]."&tmp_type=".$row["type"]."<br><br></a>";
	    	...
	    	$body .= "<a href='http://www.hksm.com.hk/ecard201012a/getcard.php?batch=1&code=".$row["card_code"]."&tmp_type=".$row["type"];
	    	$body .= "'>http://www.hksm.com.hk/ecard201012a/getcard.php?batch=1&code=".$row["card_code"]."&tmp_type=".$row["type"]."</a><br><br><br>";

...
function emailToJoin($course, $name, $phone, $email, $id, $area, $age, $job, $comment){
	...
	$suject = "[" .$course ."][". $name ."][". date("d/m/Y H:i:s") ."]";
...
function emailToApply($job, $job_code, $name, $address, $area, $phone, $email, $ps){
	global $_CONFIG, $_LANG;

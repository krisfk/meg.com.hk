...
//var iTimerID = setInterval("countDown()", 100);
var iTimerID = setInterval("countDown2()", 1000);
var red = false;
var lastTick = 0;
function countDown() {
//	var create_time = document.frmTest.create_time.value;
//	var expired_time = document.frmTest.expired_time.value;
...
//	document.all.ExamTimer.innerHTML = "考試時間：" + formatTime(passTime);
	$('#ExamTimer').html(formatTime(passTime));
	if (remainTime <= ExamReminder && (now - lastTick >= 1000)) {

...
$(document).ready(function(){
		<!--loop();  car-->
		   ...
		   $("#promotion1").click(function(){
			window.open('https://meg.com.hk/event/minimovie2017/index.html');
		    
		   });
		   
		   $("#promotion2").click(function(){
			window.open('https://www.meg.com.hk/promo/ad3.html');
		   ...
		   $("#A1, #A1_logo, #A1_s").click(function(){
			window.open('https://www.a1driving.com.hk/');
		   ...
		   $("#autotoll").click(function(){
			...
			$("#megclub").click(function(){
			window.open('https://www.megclub.com.hk/');
		   ...
		   $("#enroll").click(function(){
			window.open('https://meg.com.hk/promo/payment_may2017.html');

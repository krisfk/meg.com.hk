...
<?
	...
	<div><img alt="ad" border="0" src="ad_1k_63.png" width="1000" height="951" usemap="#brandmap"></div>
	...
	<div style='padding:20px 0px'>
		<form method="post" action="Savemeg_reg.php" name="frmRegistration" onSubmit="return submitForm();" accept-charset="UTF-8">
			...
			<div><input type="hidden" name="txtFormNo" value="63"></div><?php // !!! Matthew 2014-01-23 22 For PDI Course ?>

	...
	<div style='max-width:800px'>
		...
		<div>
			<table cellpadding="0" border="0" cellspacing="0" width='100%' style='min-width:200px'>
				<tr>
					<td width='25%' valign="middle"><a href='http://www.hksm.com.hk/tc/index.html'                            ><img src="slice_0_2a.png" style="width:100%;border-width:0px" alt="hksm"    ></td>
					...
					<td width='23%' valign="middle"><a href='http://www.hksm.com.hk/tc/index.html'><img src="slice_0_0a.png" style="width:100%;border-width:0px" alt="hksm"></td>
					<td width='30%' valign="middle"><a href='http://www.hksm.com.hk/tc/index.html'        ><img src="slice_0_3a.png" style="width:100%;border-width:0px" alt="hksm"     ></td>
				</tr>
			</table>
		</div>

		<div><img alt="ad" border="0" src="77page.jpg" width="100%" style='vertical-align:middle;min-width:200px' /></div>

		<div style='padding:10px 0px'>
			<div><b>香港駕駛學院獨家呈獻：MEG哥之變折</b></div>
			<div><b>MEG哥不停變出學車優恵，現報讀香港駕駛學院15堂私家車/輕型貨車課程，即送你考試攻略A，內容包括：</b></div>
			<div><b>-模擬考試</b></div>
			<div><b>-基礎訓練</b></div>
			<div><b>-獨立訓練</b></div>
			<div><b>-長距離駕駛練習</b></div>

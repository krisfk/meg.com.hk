...
//             $('.result-tr-'+data.price_idx).find('.staff_id_td').html(staff_id);
   ...
   $('.edit-form-cancel-btn').click(function(e){
    ...
    $('.edit-form-save-btn').click(function(e){
        ...
        var found=false;
        if($('.result-tr-'+price_idx).find('.staff_id_td').html()=='')
            {
                          for(i=0;i<$('.staff_id_td').size();i++)
                    {
                    //    alert($('.staff_id_td').html().toUpperCase().replace(" ","")+ " " + staff_id.toUpperCase().replace(" ",""));
                        if($('.staff_id_td').eq(i).html().toUpperCase().replace(" ","")===staff_id.toUpperCase().replace(" ",""))
                            {
                                found=true;
                            }
                    }

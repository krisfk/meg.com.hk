...
class smtp_client {
   ...
   var $server; 
   var $elog_fp; 
   //var $log_file='/var/www/html/member/smtplog.log'; 
   var $log_file='/web/member/smtplog.log';   
   var $do_log=true;
   ...
   function smtp_client($server='') { 
      ...
      if ($this->connection <= 0) return 0; 
        ...
        //$base64_username=base64_encode('barrykui');
        //$this->elog("$base64_username", 1);
        //fputs($this->connection,"$base64_username\r\n"); 
        //$this->elog(fgets($this->connection, 1024));

        //$base64_password=base64_encode('875371');
